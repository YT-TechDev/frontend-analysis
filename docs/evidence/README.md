...
| --- | --- | --- |
| HTML | Candidate C / ADR 0010 remain authoritative. The second bounded HTML production wave is accepted and pauseable through TC-S10: TC-S9 establishes selected Style/RAWTEXT tree↔tokenizer feedback, and TC-S10 establishes selected Title/RCDATA + Named Character Reference semantics, canonical WHATWG Named data ownership, non-committing maximum-match observation, and resource-atomic commit. No next HTML successor is preselected and complete HTML support is not claimed. | [HTML evidence](html/README.md) · [2026-09 post-TC-S10 checkpoint](html/2026-09-post-tc-s10-accepted-baseline-checkpoint.md) · [ADR 0010](../decisions/0010-html-tree-construction-architecture.md) · [HTML tree-construction contract](../architecture/HTML_TREE_CONSTRUCTION.md) |
| CSS | The #184/#185 Semantic Foundation remains the source/tokenizer/parser/context/selector foundation, and later focused work establishes a substantial bounded authored-value qualification layer. Current normative `transform` Function selected coverage is complete at 21 / 21 while unknown/future Function containment remains explicit. CSS is pauseable, not complete, and the 2026-09 checkpoint is the current resume record. | [CSS evidence](css/README.md) · [2026-09 authored-value/transform checkpoint](css/2026-09-authored-value-qualification-and-transform-coverage-checkpoint.md) · [2026-08 historical foundation checkpoint](css/2026-08-semantic-foundation-status-checkpoint.md) |
| JavaScript / ECMAScript | Architecture Model v1.1 is accepted; the subsequent adversarial research wave is closed/frozen with no architecture-breaking contradiction found, while later bounded selected-qualification work continues beyond the dated post-#343 evidence checkpoint. The JavaScript evidence README remains the entry point until the current ECMAScript wave receives its next durable checkpoint. | [JavaScript evidence](javascript/README.md) · [Post-v1.1 closure](javascript/2026-08-post-v1.1-research-wave-closure.md) |
